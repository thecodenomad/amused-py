...
# Configuration
from .muse_config import get_device_config, detect_device_model_from_name

# Real-time decoding
from .muse_decoder import MuseRealtimeDecoder, DecodedData

# Legacy clients for testing
from .muse_stream_client import MuseStreamClient as LegacyMuseStreamClient
...
__all__ = [
    "MuseStreamClient",
    "get_device_config",
    "detect_device_model_from_name",
    "MuseRealtimeDecoder",
    "DecodedData",
    "LegacyMuseStreamClient",
    "MuseExactClient",
    "MuseSleepClient",
    "MuseRawStream",
    "RawPacket",
